...
<div id="ft">
    <div id="ft_wr">
       <div id="ft_sns">
        ...
        <div id="ft_contact">
            <strong>TOURITHM</strong>
        </div>
        <div id="ft_link">
            <a href="">투어리즘</a>
            <a href="">Tourism + Algorithm</a>
            <a class="ft_link3" href="">Tourithm</a>
        </div>

        <div id="ft_company">
            <ul>
                <li class="ft_company1">한국관광공사</li>
                <li class="ft_company2">2022</li>
                <li class="ft_company2">관광데이터 활용 공모전</li>
                <li class="ft_company4">TEAM. min2day</li>
                <li class="ft_company3">변민정</li>
            </ul>
        </div>

        <div id="ft_copy">
            Copyright &copy; <b>Tourithm</b> <span>All rights reserved.</span>
        </div>
    </div>
