...
<div class="ing_bnr_Wrap">
    ...
    <div class="bnrtxtwrap">
        ...
        <p class="wow fadeInDown" data-wow-delay="0.2s">투어리즘에 등재된 국내 맛집 목록입니다.</p>
    </div>

</div>
<div class="mdlTxt">
    <h2 class="wow flipInX" data-wow-duration="2s">국내 맛집 목록</h2>
</div>
...
<?php
include_once('./food_local_select.php');
?>
    ...
    <div class="inner">
            ...
            //$local = '<script> document.write(anText); </script>';
              ...
              class Pagination {
                  ...
                  $prev_block,
                  $prev_block_page,
                  $PHP_SELF = "https://idox23.cafe24.com/theme/AT_WEB01/company/tour_list/kr_food/kr_food_list.php";
                  ...
                  public function __construct($pg, $bl, $dbName) {
                      ...
                      $query = "SELECT count(name) AS total FROM kr_food";
              ...
              //데이터 로드
              $query = "SELECT * FROM kr_food ORDER BY ranking LIMIT " . $pagination->limit_idx . ", " . $pagination->page_set;
              $stmt = $db->prepare($query);
              $stmt->execute();
              ...
              <ul>
                ...
                <script>
                  ...
                  function send_data(ths){
                    ...
                    var value = world1[1];
                    //alert('값 : ' + value);
                    location.href = "./kr_food_info.php?value=" + value;
