...
<div class="ing_bnr_Wrap">
    ...
    <div class="bnrtxtwrap">
        ...
        <p class="wow fadeInDown" data-wow-delay="0.2s">투어리즘에 등재된 국내 관광지 목록입니다.</p>
    </div>

</div>
<div class="mdlTxt">
    <h2 class="wow flipInX" data-wow-duration="2s">국내 관광지 목록</h2>
</div>
...
<?php
include_once('./tour_local_select.php');
?>
    ...
    <div class="inner">
            ...
            //$local = '<script> document.write(anText); </script>';
              ...
              class Pagination {
                  ...
                  $prev_block,
                  $prev_block_page,
                  $PHP_SELF = "https://idox23.cafe24.com/theme/AT_WEB01/company/tour_list/kr_tour/kr_tour_list.php";
