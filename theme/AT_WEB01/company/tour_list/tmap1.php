...
<html>
	<head>
      ...
      var locaAr1 = parent.locaAr1; var locaAr2 = parent.locaAr2;

      //pos1 = (locaAr1[1]+locaAr2[1])/2; pos2 = (locaAr1[2]+locaAr2[2])/2;

			function initTmap() {
				// 1. 지도 띄우기
				map = new Tmapv2.Map("map_div", {
					center : new Tmapv2.LatLng(locaAr1[1], locaAr1[2]),
					width : "100%",
					height : "400px",
					zoom : 11,
					zoomControl : true,
								...
								function() {
									...
									$
											.ajax({
												...
												async : false,
												data : {
													"appKey" : "l7xx7807c8cd9d1044f4862405a9a166bbca",
													"startX" : locaAr1[2],
													"startY" : locaAr1[1],
													"endX" : locaAr2[2],
													"endY" : locaAr2[1],
