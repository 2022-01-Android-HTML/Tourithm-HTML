...
// 2차원 배열
    ...
    var locations = [
      ...
      ['을왕리해수욕장', 37.445091, 126.372930],
      ['대이작도', 37.174918, 126.258784]
    ];
    ...
    //지도 띄우기
      var map = new google.maps.Map(document.getElementById('map'),{
        zoom: 10,
        center: {lat: 37.445091, lng: 126.372930},
...
else if(value == "인천 여행2"){
  var locations = [
    ['석모도 미네랄 온천', 37.685431, 126.312767],
    ['강화 아르미애월드', 37.702926, 126.434756],
  ...
  //지도 띄우기
    var map = new google.maps.Map(document.getElementById('map'),{
      zoom: 11,
      center: {lat: 37.702926, lng: 126.434756},
      mapTypeId: google.maps.MapTypeId.ROADMAP
      });
...
else if(value == "인천 여행3"){
  var locations = [
    ['인천 차이나타운', 37.473850, 126.619162],
    ['자유공원(인천)', 37.475295, 126.622276],
    ['인천대공원', 37.457674, 126.749273],
    ['계양산 산림욕장', 37.546568, 126.712254]
  ];
  function initMap() {
  //지도 띄우기
    var map = new google.maps.Map(document.getElementById('map'),{
      zoom: 12,
      center: {lat:37.475295, lng: 126.622276},
      mapTypeId: google.maps.MapTypeId.ROADMAP
      });
