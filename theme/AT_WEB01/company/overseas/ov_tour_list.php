...
<div class="mdlTxt">
    <h2 class="wow flipInX" data-wow-duration="2s">해외 여행지 목록</h2>
</div>
    ...
    <div class="inner">
        ...
        //$local = '<script> document.write(anText); </script>';
          ...
          if ($local == "1") {
            ...
            $tablename = 'us_lasvegas';
          } else if ($local == "3") {
            $tablename = 'us_losangeles';
          } else if ($local == "4") {
            $tablename = 'us_newyork';
          } else {
            $tablename = 'us_sanfrancisco';
          }
